...
$res=mysqli_query($con,"UPDATE patient SET patientFirstName='$patientFirstName', patientLastName='$patientLastName', patientMaritialStatus='$patientMaritialStatus',             ='$', gender='$gender', address='$address', phone=$phone, email='$email' WHERE icPatient=".$_SESSION['patientSession']);
                                                ...
                                                <form action="<?php $_PHP_SELF ?>" method="post" name="form1" id="form1">
                                                    <table class="table table-user-information">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>address</td>
                                                                <td><input type="text" class="form-control" name="address" value="<?php echo $userRow['address']; ?>"  /></td>
                                                            </tr>
                                                            <tr>
                                                                <td>phone</td>
